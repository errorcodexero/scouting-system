namespace XeroScouterDBManage_Server
{
	partial class TeamMatchActionEntryForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.lblScouter.Location = new System.Drawing.Point(341, 193);
			this.lblScouter.Name = "lblScouter";
			this.lblScouter.Size = new System.Drawing.Size(121, 32);
			this.lblScouter.TabIndex = 0;
			this.lblScouter.Text = "Scouter:";
			// 
			// txtScouter
			// 
			this.txtScouter.Location = new System.Drawing.Point(474, 190);
			this.txtScouter.Name = "txtScouter";
			this.txtScouter.Size = new System.Drawing.Size(567, 38);
			this.txtScouter.TabIndex = 1;
			// 
			// txtMatchNumber
			// 
			this.txtMatchNumber.Location = new System.Drawing.Point(206, 312);
			this.txtMatchNumber.Name = "txtMatchNumber";
			this.txtMatchNumber.Size = new System.Drawing.Size(238, 38);
			this.txtMatchNumber.TabIndex = 3;
			// 
			// lblMatchNumber
			// 
			this.lblMatchNumber.AutoSize = true;
			this.lblMatchNumber.Location = new System.Drawing.Point(78, 315);
			this.lblMatchNumber.Name = "lblMatchNumber";
			this.lblMatchNumber.Size = new System.Drawing.Size(116, 32);
			this.lblMatchNumber.TabIndex = 2;
			this.lblMatchNumber.Text = "Match#:";
			// 
			// txtTeamNumber
			// 
			this.txtTeamNumber.Location = new System.Drawing.Point(623, 312);
			this.txtTeamNumber.Name = "txtTeamNumber";
			this.txtTeamNumber.Size = new System.Drawing.Size(238, 38);
			this.txtTeamNumber.TabIndex = 5;
			// 
			// lblTeamNumnber
			// 
			this.lblTeamNumnber.AutoSize = true;
			this.lblTeamNumnber.Location = new System.Drawing.Point(495, 315);
			this.lblTeamNumnber.Name = "lblTeamNumnber";
			this.lblTeamNumnber.Size = new System.Drawing.Size(111, 32);
			...
			this.lblAllianceColor.Location = new System.Drawing.Point(911, 315);
			this.lblAllianceColor.Name = "lblAllianceColor";
			this.lblAllianceColor.Size = new System.Drawing.Size(200, 32);
            ...
            "Blue",
            "Red"});
			this.cmbAllianceColor.Location = new System.Drawing.Point(1128, 312);
			this.cmbAllianceColor.Name = "cmbAllianceColor";
			this.cmbAllianceColor.Size = new System.Drawing.Size(209, 39);
			...
			this.lblAddAMatch.Location = new System.Drawing.Point(467, 53);
			this.lblAddAMatch.Margin = new System.Windows.Forms.Padding(8, 0, 8, 0);
			this.lblAddAMatch.Name = "lblAddAMatch";
			this.lblAddAMatch.Size = new System.Drawing.Size(457, 69);
			...
			this.lblBlueAlliance.Location = new System.Drawing.Point(642, 426);
			this.lblBlueAlliance.Margin = new System.Windows.Forms.Padding(8, 0, 8, 0);
			this.lblBlueAlliance.Name = "lblBlueAlliance";
			this.lblBlueAlliance.Size = new System.Drawing.Size(107, 46);
			...
			this.label11.Location = new System.Drawing.Point(617, 591);
			this.label11.Margin = new System.Windows.Forms.Padding(8, 0, 8, 0);
			this.label11.Name = "label11";
			this.label11.Size = new System.Drawing.Size(156, 46);
			this.label11.TabIndex = 39;
			this.label11.Text = "TeleOp";
			// 
			// txtTeleBunniesScored
			// 
			this.txtTeleBunniesScored.Location = new System.Drawing.Point(1285, 656);
			this.txtTeleBunniesScored.Name = "txtTeleBunniesScored";
			this.txtTeleBunniesScored.Size = new System.Drawing.Size(84, 38);
			this.txtTeleBunniesScored.TabIndex = 41;
			// 
			// lblTeleBunniesScored
			// 
			this.lblTeleBunniesScored.AutoSize = true;
			this.lblTeleBunniesScored.Location = new System.Drawing.Point(1065, 659);
			this.lblTeleBunniesScored.Name = "lblTeleBunniesScored";
			this.lblTeleBunniesScored.Size = new System.Drawing.Size(224, 32);
			this.lblTeleBunniesScored.TabIndex = 40;
			this.lblTeleBunniesScored.Text = "Bunnies Scored:";
			// 
			// txtNerfShotsMissed
			// 
			this.txtNerfShotsMissed.Location = new System.Drawing.Point(907, 822);
			this.txtNerfShotsMissed.Name = "txtNerfShotsMissed";
			this.txtNerfShotsMissed.Size = new System.Drawing.Size(238, 38);
			this.txtNerfShotsMissed.TabIndex = 45;
			// 
			// lblNerfShotsMissed
			// 
			this.lblNerfShotsMissed.AutoSize = true;
			this.lblNerfShotsMissed.Location = new System.Drawing.Point(707, 825);
			this.lblNerfShotsMissed.Name = "lblNerfShotsMissed";
			this.lblNerfShotsMissed.Size = new System.Drawing.Size(193, 32);
			this.lblNerfShotsMissed.TabIndex = 44;
			this.lblNerfShotsMissed.Text = "Shots Missed:";
			// 
			// txtNerfShotsHit
			// 
			this.txtNerfShotsHit.Location = new System.Drawing.Point(418, 822);
			this.txtNerfShotsHit.Name = "txtNerfShotsHit";
			this.txtNerfShotsHit.Size = new System.Drawing.Size(238, 38);
			this.txtNerfShotsHit.TabIndex = 43;
			// 
			// lblNerfShotsHit
			// 
			this.lblNerfShotsHit.AutoSize = true;
			this.lblNerfShotsHit.Location = new System.Drawing.Point(290, 825);
			this.lblNerfShotsHit.Name = "lblNerfShotsHit";
			this.lblNerfShotsHit.Size = new System.Drawing.Size(138, 32);
			...
			this.label15.Location = new System.Drawing.Point(625, 747);
			this.label15.Margin = new System.Windows.Forms.Padding(8, 0, 8, 0);
			this.label15.Name = "label15";
			this.label15.Size = new System.Drawing.Size(133, 46);
			...
			this.chkDefenceFlag.Location = new System.Drawing.Point(440, 930);
			this.chkDefenceFlag.Name = "chkDefenceFlag";
			this.chkDefenceFlag.Size = new System.Drawing.Size(222, 36);
			...
			this.chkBreakdownFlag.Location = new System.Drawing.Point(698, 930);
			this.chkBreakdownFlag.Name = "chkBreakdownFlag";
			this.chkBreakdownFlag.Size = new System.Drawing.Size(258, 36);
			...
			// btnSave
			// 
			this.btnSave.Location = new System.Drawing.Point(430, 1019);
			this.btnSave.Name = "btnSave";
			this.btnSave.Size = new System.Drawing.Size(206, 94);
			...
			this.btnCancel.Location = new System.Drawing.Point(727, 1019);
			this.btnCancel.Name = "btnCancel";
			this.btnCancel.Size = new System.Drawing.Size(206, 94);
			...
			this.ClientSize = new System.Drawing.Size(1418, 1156);
			this.Controls.Add(this.btnCancel);
			this.Controls.Add(this.btnSave);
			this.Controls.Add(this.chkBreakdownFlag);
			this.Controls.Add(this.chkDefenceFlag);
			this.Controls.Add(this.label15);
			this.Controls.Add(this.txtNerfShotsMissed);
			this.Controls.Add(this.lblNerfShotsMissed);
			this.Controls.Add(this.txtNerfShotsHit);
			this.Controls.Add(this.lblNerfShotsHit);
			this.Controls.Add(this.txtTeleBunniesScored);
			this.Controls.Add(this.lblTeleBunniesScored);
			this.Controls.Add(this.label11);
			this.Controls.Add(this.lblBlueAlliance);
			this.Controls.Add(this.txtTeleBunniesStolen);
			this.Controls.Add(this.lblTeleBunniesStolen);
			this.Controls.Add(this.txtTeleBunniesGround);
			this.Controls.Add(this.lblTeleBunniesGround);
			this.Controls.Add(this.txtTeleLinesCrossed);
			this.Controls.Add(this.lblTeleLinesCrossed);
			this.Controls.Add(this.txtAutoBunniesScored);
			this.Controls.Add(this.lblAutoBunniesScored);
			this.Controls.Add(this.txtAutoBunniesPicked);
			this.Controls.Add(this.lblAutoBunniesPicked);
			this.Controls.Add(this.txtAutoLinesCrossed);
			this.Controls.Add(this.lblAutoLinesCrossed);
			this.Controls.Add(this.lblAddAMatch);
			this.Controls.Add(this.cmbAllianceColor);
			this.Controls.Add(this.lblAllianceColor);
